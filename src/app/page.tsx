...
import { Brain, Cpu, Eye, ArrowLeft, Play, Pause, RotateCcw, Sliders, BookOpen, Zap, Target, ChevronRight } from 'lucide-react';
...
const AILearningPlatform = () => {
  ...
  const InteractiveDemo = ({ modelKey, categoryKey }) => {
    ...
    if (modelKey === 'kmeans' && categoryKey === 'ml') {
      ...
      const [clusterData, setClusterData] = useState(generateClusters(k));
